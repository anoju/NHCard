<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<nav id="gnb" aria-hidden="true">
		<div class="gnb_header">
			...
			<div class="gnb_info">
				...
				<div>
					...
					<h2 class="tit"><strong>홍길동</strong>님, 반가워요.</h2>
					<div class="cont">
						<span class="my_level lv_0"><strong>VIP</strong><span class="blind">등급</span></span><!-- lv_0:VIP, lv_1:Prime, lv_2:Royal, lv_3:Super Royal, lv_4:Noblesse -->
						<span class="last_date">최근접속 <span class="roboto3">2019.10.24 17:34</span></span>
					</div>
				</div>
			</div>
			<div class="gnb_link">
				<ul class="grid col3">
					...
					<li><a href="#"><i class="ic_2" aria-hidden="true"></i><span>인증센터</span></a></li>
					<li><a href="#"><i class="ic_3" aria-hidden="true"></i><span>로그인 설정</span></a></li>
				</ul>
			</div>
		</div>
		<div class="gnb_content">
			...
			<div class="gnb_dep1">
				<ul>
					<li><a href="#"><span>MY NH</span></a></li>
					<li><a href="#"><span>혜택</span></a></li>
					<li><a href="#"><span>카드</span></a></li>
					<li><a href="#"><span>금융</span></a></li>
					<li><a href="#"><span>생활&middot;편의</span></a></li>
			...
			<div class="gnb_sub">
				...
				<div class="gnb_pagination" aria-hidden="true"></div>
			</div>
		</div>
	</nav>
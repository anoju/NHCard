...
<script>
	$(function(){
		...
		*/
		...
		//탭에 활성화(a태그에 별도의 id를 부여해서 수정해도 무방)
		//$('[href=#tabCertify1]').click(); //휴대폰 활성화 시
		//$('[href=#tabCertify3]').click(); //공인인증서 활성화 시 
		$('[href=#tabCertify6]').click(); //잠금번호 활성화 시 
...
<div id="userCertifyPop" class="popup full" role="dialog" aria-hidden="true">
	<article class="pop_wrap">
		...
		<div class="pop_cont user_check_wrap">
						...
						<div class="fm_cont phone">
							...
							<div class="tbl mt10">
								...
								<div class="td va_mid w_114">
									...
									<!-- <a href="#" class="button line blue fz_14">인증번호 재전송</a> -->
								</div>
							</div>
			...
			<!--잠금번호(스마트앱)-->
			<div id="tabCertify6" class="tab_panel bg_blue">
				<!-- 잠금번호 설정 -->
				<div class="pwd_wrap">
					<h3 class="fz_17 t_center">잠금번호 비밀번호<br>6자리를 입력해주세요.</h3>
					
					<div class="password ty2">
				...
				<div class="btn_wrap bottom_fixed">
					<div class="flex">
						<button type="button" class="button h54 blue" disabled>잠금번호 인증</button><!-- disabled속성 추가:버튼 비활성, disabled속성 제거:버튼 활성-->
					</div>
				</div>
			</div>

			<!--PIN번호(모바일웹)-->
			<div id="tabCertify7" class="tab_panel bg_blue">
				<!-- PIN번호 설정 -->
				<div class="pwd_wrap">
					<h3 class="fz_17 t_center">PIN번호<br>6자리를 입력해주세요.</h3>
					<div class="password ty2">
						<div class="dot" aria-hidden="true"><span></span><span></span><span></span><span></span><span></span><span></span></div>
				...
				<div class="btn_wrap bottom_fixed">
					<div class="flex">
						<button type="button" class="button h54 blue" disabled>PIN번호 인증</button><!-- disabled속성 추가:버튼 비활성, disabled속성 제거:버튼 활성-->
					</div>
				</div>
			</div>
			...
			<div id="tabCertify8" class="tab_panel">
				...
				<div class="btn_wrap bottom_fixed">
					<div class="flex">
						<button type="button" class="button h54 blue" disabled>지문 인증</button><!-- disabled속성 추가:버튼 비활성, disabled속성 제거:버튼 활성-->
					</div>
				</div> 
			</div>
			...
			<div id="tabCertify9" class="tab_panel">
				...
				<div class="btn_wrap bottom_fixed">
					<div class="flex">
						<button type="button" class="button h54 blue" disabled>Face ID 인증</button><!-- disabled속성 추가:버튼 비활성, disabled속성 제거:버튼 활성-->
					</div>
				</div>
			</div>
...
<div id="ctfFingerGuidePop" class="popup modal" role="dialog" aria-hidden="true">
	<article class="pop_wrap">
		...
		<div class="pop_btn btn_wrap bottom_fixed">
			<div>
				<div class="flex">
					<a href="#" class="button h54 gray ui-pop-close">취소</a><!-- ui-pop-close클래스로 팝업 닫기 가능 -->
				</div>
			</div>
		</div>
	</article>

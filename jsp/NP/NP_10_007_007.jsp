...
<article id="wrap">
	...
	<div id="container">
		<section id="contents">
			<div class="section">
				<h2 class="blind">4대 사회보험료 자동납부 신청완료</h2>
				<div class="complete_wrap">
					<i class="i_ico_50 ico_1" aria-hidden="true"></i>
					<h2 class="tit_h2">신청 완료</h2>
					<p class="txt">4대 사회보험료 자동이체 신청이 완료되었습니다.</p>
				</div>
				<div class="table">
					<table>
				...
				<div class="caution_txt mt10">납부마감일에 임대료가 승인되며, 납부마감일이 휴일인 경우 익영업일에 임대료 승인됩니다.</div>
			</div>

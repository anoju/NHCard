			...
			<div class="section">
					...
					<div class="chk_item">
						...
						<div class="chk_child">
							...
							<div class="checkbox large">
								...
								<label for="agree1_4" class="lbl">[필수] 피싱/해킹금융사기 보상보험가입</label>
								<a href="#agreePop4" class="chk_link ui-pop-open"><span class="blind">피싱/해킹금융사기 보상보험가입 확인하기</span></a>
							</div>
						</div>
					</div>
				</div>
				<div class="caution_txt mt10">NH신용Manager플러스 가입고객은 피싱·해킹 금융사기보상보험에 무상으로 가입됩니다.</div>
				<dl class="accordion_list accordion_dl mt25">
					...
					<dd class="panel">
						<div class="txt_list">
							<ul>
								<li class="dot">NH신용 Manager서비스는 월정액제 유료서비스로 이용료가 청구됩니다.</li>
